...
def build_cnn_lstm(input_shape, num_classes, dropout_rate=0.3, recurrent_dropout=0.2, l2_reg=0.001, learning_rate=0.001):
    """
    ...
    model = models.Sequential([
        ...
        # LSTM block - using bidirectional for better feature extraction
...
def train_cnn_lstm(X_train, y_train, X_val=None, y_val=None, input_shape=None, num_classes=None, 
    ...
    """
    Train the CNN-LSTM hybrid model with advanced training techniques from model.py and enhanced_model.py.
    ...
    model = build_cnn_lstm(input_shape, num_classes, dropout_rate, recurrent_dropout, l2_reg, learning_rate)
    ...
    callbacks.append(ModelCheckpoint(
        'models/checkpoints/cnn_lstm_best.h5',
        monitor='val_loss' if X_val is not None else 'loss',
        save_best_only=True
    ))
