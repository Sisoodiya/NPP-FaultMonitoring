...
def build_lstm(input_shape, num_classes, dropout_rate=0.4, recurrent_dropout=0.0, l2_reg=0.001, 
    ...
    units_second = int(64 * units_multiplier)
    ...
    # Second LSTM layer (bidirectional if enabled)
    if use_bidirectional:
    ...
    if use_wks:
        ...
        x = layers.Concatenate()([lstm2, wks_flat])
    else:
        x = lstm2
    ...
    # Add dense layer
    x = layers.Dense(
        units=int(128 * units_multiplier),
...
def train_lstm(X_train, y_train, X_val=None, y_val=None, input_shape=None, num_classes=None, 
             ...
             use_bidirectional=True, units_multiplier=1.0,
             use_focal_loss=False, focal_gamma=2.0, focal_alpha=0.25, use_wks=False,
    ...
    """
    Train the LSTM model with advanced training techniques from the SIAO model.
    ...
    if checkpoint_path is None:
        ...
        checkpoint_path = f"models/checkpoints/lstm_{timestamp}/best_model.h5"
